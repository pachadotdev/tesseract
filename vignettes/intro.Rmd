...
tesseract_download("chi_sim", datapath = "~/Downloads", model = "best")
...
tesseract_download("grc", datapath = "~/Downloads", model = "best")
tesseract_contributed_download("grc_hist", datapath = "~/Downloads", model = "best")

# compare the results: grc (text1) vs grc_hist (text2)
text1 <- ocr(file, engine = tesseract("grc", datapath = "~/Downloads"))
text2 <- ocr(file, engine = tesseract("grc_hist", datapath = "~/Downloads"))
```
